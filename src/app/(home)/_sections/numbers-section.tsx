...
const NumbersSection = () => {
  return (
    <div className="text-dark-foreground text-center">
      <div className="bg-gradient-to-t from-dark-background from-20% to-dark-background/90 p-12">
        <h4 className="text-xl mt-8 mb-2">We've completed</h4>
        <h3 className="text-lg ">
          more than <span className="text-3xl font-bold px-2">2 500+</span>{' '}
          activities successfully
        </h3>
        <div className="justify-center gap-20 pt-14 flex">
          <div className="w-[200px] flex justify-center items-center flex-col gap-1 p-5">
      ...
      <div
        className={`bg-dark-background overflow-hidden relative max-h-[500px] flex justify-center p-12`}
      >
